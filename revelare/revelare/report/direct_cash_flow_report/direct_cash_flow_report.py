...
def execute(filters=None):
	...
	new_path = "/home/alain/sihaysistema/apps/revelare/revelare/revelare/report/direct_cash_flow_report/hello_world.txt"
	accts_file = open(new_path,'w')
	title = "hola mundo"
	accts_file.write(title)
	accts_file.close()
